           ...
           <h1>Karty graficzne!</h1>
            <table>
              ...
              <?php
                        ...
                        $result=$conn->query("SELECT items.idItem, items.nazwa, cena,image from items inner join category on items.idCategory=category.idCategory where category.nazwa='karta graficzna'");
